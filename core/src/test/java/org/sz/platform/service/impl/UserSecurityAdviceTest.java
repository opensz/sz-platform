...
import org.sz.platform.Constants;
import org.sz.platform.dao.UserDao;
import org.sz.platform.model.Role;
import org.sz.platform.model.User;
import org.sz.platform.service.UserManager;
import org.sz.platform.service.UserSecurityAdvice;
...
public class UserSecurityAdviceTest {
    ...
    private UserManager makeInterceptedTarget() {
        ctx = new ClassPathXmlApplicationContext("/config/spring-test.xml");
