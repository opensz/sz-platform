...
public abstract interface SystemResourcesService
{
  ...
  public abstract List<ResourcesUrlExt> loadSecurityFunction(String paramString);

  @WebMethod(operationName="SystemResourcesService_loadSecurityRole")
  public abstract List<SysRole> loadSecurityRole(String paramString1, String paramString2);
  ...
  public abstract List<ResourcesUrlExt> checkSecurityFunction(String paramString);
}
