...
import org.sz.core.model.BaseModel;
 ...
 public class Demension extends BaseModel
 {
   ...
   public boolean equals(Object object)
   {
     ...
     return new EqualsBuilder().append(this.demId, rhs.demId).append(this.demName, rhs.demName).append(this.demDesc, rhs.demDesc).isEquals();
   }
 
   public int hashCode()
   {
     return new HashCodeBuilder(-82280557, -700257973).append(this.demId).append(this.demName).append(this.demDesc).toHashCode();
   }
 
   public String toString()
   {
     return new ToStringBuilder(this).append("demId", this.demId).append("demName", this.demName).append("demDesc", this.demDesc).toString();
   }
