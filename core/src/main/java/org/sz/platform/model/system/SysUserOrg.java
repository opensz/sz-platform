...
public boolean equals(Object object)
   ...
   public int hashCode()
   {
     return new HashCodeBuilder(-82280557, -700257973).append(this.userOrgId).append(this.orgId).append(this.userId).append(this.isPrimary).append(this.isCharge).toHashCode();
   }
 
   public String toString()
   {
     return new ToStringBuilder(this).append("userOrgId", this.userOrgId).append("orgId", this.orgId).append("userId", this.userId).append("isPrimary", this.isPrimary).append("isCharge", this.isCharge).toString();
   }
 }
