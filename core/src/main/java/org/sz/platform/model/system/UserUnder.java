...
import org.sz.core.model.BaseModel;
 ...
 public class UserUnder extends BaseModel
 {
   ...
   public boolean equals(Object object)
   {
     ...
     return new EqualsBuilder().append(this.id, rhs.id).append(this.userid, rhs.userid).append(this.underuserid, rhs.underuserid).append(this.underusername, rhs.underusername).isEquals();
   }
 
   public int hashCode()
   {
     return new HashCodeBuilder(-82280557, -700257973).append(this.id).append(this.userid).append(this.underuserid).append(this.underusername).toHashCode();
   }
 
   public String toString()
   {
     return new ToStringBuilder(this).append("id", this.id).append("userid", this.userid).append("underuserid", this.underuserid).append("underusername", this.underusername).toString();
   }
 }
