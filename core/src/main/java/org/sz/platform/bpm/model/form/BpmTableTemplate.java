...
public class BpmTableTemplate extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.id, rhs.id)
				...
				.append(this.htmlList, rhs.htmlList)
				.append(this.htmlDetail, rhs.htmlDetail)
				.append(this.templateName, rhs.templateName).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.id)
				.append(this.tableId).append(this.categoryId)
				.append(this.htmlList).append(this.htmlDetail)
				.append(this.templateName).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", this.id)
				...
				.append("htmlList", this.htmlList)
				.append("htmlDetail", this.htmlDetail)
				.append("templateName", this.templateName).toString();
	}
}
