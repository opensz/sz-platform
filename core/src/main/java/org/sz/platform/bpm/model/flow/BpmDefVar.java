...
public class BpmDefVar extends BaseModel implements Cloneable {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.varId, rhs.varId)
				...
				.append(this.varScope, rhs.varScope).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.varId)
				.append(this.defId).append(this.varName).append(this.varKey)
				.append(this.varDataType).append(this.defValue)
				.append(this.nodeName).append(this.versionId)
				.append(this.actDeployId).append(this.nodeId)
				.append(this.varScope).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("varId", this.varId)
				.append("defId", this.defId).append("varName", this.varName)
				...
				.append("varScope", this.varScope).toString();
	}
