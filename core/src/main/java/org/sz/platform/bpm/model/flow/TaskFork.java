...
import org.sz.core.model.BaseModel;
 ...
 public class TaskFork extends BaseModel
 {
   ...
   public boolean equals(Object object)
   {
     ...
     return new EqualsBuilder().append(this.taskForkId, rhs.taskForkId).append(this.actInstId, rhs.actInstId).append(this.forkTaskName, rhs.forkTaskName).append(this.forkTaskKey, rhs.forkTaskKey).append(this.forkSn, rhs.forkSn).append(this.forkCount, rhs.forkCount).append(this.fininshCount, rhs.fininshCount).append(this.forkTime, rhs.forkTime).append(this.joinTaskKey, rhs.joinTaskKey).append(this.joinTaskName, rhs.joinTaskName).isEquals();
   }
 
   public int hashCode()
   {
     return new HashCodeBuilder(-82280557, -700257973).append(this.taskForkId).append(this.actInstId).append(this.forkTaskName).append(this.forkTaskKey).append(this.forkSn).append(this.forkCount).append(this.fininshCount).append(this.forkTime).append(this.joinTaskKey).append(this.joinTaskName).toHashCode();
   }
 
   public String toString()
   {
     return new ToStringBuilder(this).append("taskForkId", this.taskForkId).append("actInstId", this.actInstId).append("forkTaskName", this.forkTaskName).append("forkTaskKey", this.forkTaskKey).append("forkSn", this.forkSn).append("forkCount", this.forkCount).append("fininshCount", this.fininshCount).append("forkTime", this.forkTime).append("joinTaskKey", this.joinTaskKey).append("joinTaskName", this.joinTaskName).toString();
   }
 }
