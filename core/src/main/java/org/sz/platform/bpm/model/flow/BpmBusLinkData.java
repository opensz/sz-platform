...
public class BpmBusLinkData extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.dataId, rhs.dataId)
				...
				.append(this.pkName, rhs.pkName).append(this.runId, rhs.runId)
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.dataId)
				.append(this.tableName).append(this.pkName).append(this.runId)
				.append(this.pkValue).append(this.actDefId).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("dataId", this.dataId)
				.append("tableName", this.tableName)
				.append("pkName", this.pkName).append("runId", this.runId)
