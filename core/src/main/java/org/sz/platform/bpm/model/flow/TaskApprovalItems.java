...
public class TaskApprovalItems extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.itemId, rhs.itemId)
				...
				.append(this.expItems, rhs.expItems).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.itemId)
				.append(this.setId).append(this.actDefId).append(this.nodeId)
				.append(this.isGlobal).append(this.expItems).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("itemId", this.itemId)
				.append("setId", this.setId).append("actDefId", this.actDefId)
				.append("nodeId", this.nodeId)
				.append("isGlobal", this.isGlobal)
				.append("expItems", this.expItems).toString();
	}
}
