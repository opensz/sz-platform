...
public class BpmTaskComment extends BaseModel {
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973)
				.append(this.commentId).append(this.runId)
				.append(this.authorId).append(this.author)
				.append(this.commentTime).append(this.content)
				.append(this.nodeName).append(this.taskId)
				.append(this.actDefId).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("commentId", this.commentId)
				.append("runId", this.runId).append("authorId", this.authorId)
