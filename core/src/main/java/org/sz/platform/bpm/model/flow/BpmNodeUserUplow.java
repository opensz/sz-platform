...
import org.sz.core.model.BaseModel;
 ...
 public class BpmNodeUserUplow extends BaseModel
 {
   ...
   public boolean equals(Object object)
   {
     ...
     return new EqualsBuilder().append(this.ID, rhs.ID).append(this.nodeUserId, rhs.nodeUserId).append(this.demensionId, rhs.demensionId).append(this.demensionName, rhs.demensionName).append(this.upLowLevel, rhs.upLowLevel).append(this.upLowType, rhs.upLowType).isEquals();
   }
 
   public int hashCode()
   {
     return new HashCodeBuilder(-82280557, -700257973).append(this.ID).append(this.nodeUserId).append(this.demensionId).append(this.demensionName).append(this.upLowLevel).append(this.upLowType).toHashCode();
   }
 
   public String toString()
   {
     return new ToStringBuilder(this).append("ID", this.ID).append("nodeUserId", this.nodeUserId).append("demensionId", this.demensionId).append("demensionName", this.demensionName).append("upLowLevel", this.upLowLevel).append("upLowType", this.upLowType).toString();
   }
