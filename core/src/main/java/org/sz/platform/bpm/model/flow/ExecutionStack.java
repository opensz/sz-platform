...
public class ExecutionStack extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.stackId, rhs.stackId)
				...
				.append(this.depth, rhs.depth).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.stackId)
				.append(this.nodeId).append(this.nodeName)
				.append(this.startTime).append(this.endTime)
				.append(this.assignees).append(this.isMultiTask)
				.append(this.parentId).append(this.actInstId)
				.append(this.taskIds).append(this.nodePath).append(this.depth)
				.toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("stackId", this.stackId)
