...
public class TaskSignData extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.dataId, rhs.dataId)
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.dataId)
				.append(this.actInstId).append(this.nodeName)
				.append(this.nodeId).append(this.taskId)
				.append(this.voteUserId).append(this.voteUserName)
				.append(this.voteTime).append(this.isAgree)
				.append(this.content).append(this.signNums)
				.append(this.isCompleted).append(this.actDefId).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("dataId", this.dataId)
				...
				.append("nodeId", this.nodeId).append("taskId", this.taskId)
