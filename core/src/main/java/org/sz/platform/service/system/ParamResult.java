...
import java.util.Map;
 ...
 public class ParamResult<T>
 {
   ...
   {
     if (this.allList == null) this.allList = new HashSet();
     if (this.conditionMap == null) this.conditionMap = new HashMap();
     this.allList.addAll(ul);
     this.conditionMap.put(condition, ul);
   }
   public ParamResult(int t, String tn) {
     this.type = t; this.typeName = tn;
   }
   ...
   {
     if ((this.type == 1) && (this.allList != null) && (this.allList.size() > 0))
       return this.allList;
     if ((this.type == 1) && ((this.allList == null) || (this.allList.size() < 0)))
       return null;
     if ((this.type == 2) && (this.allList != null) && (this.allList.size() > 0))
   ...
   {
     if (this.allList == null) return null;
