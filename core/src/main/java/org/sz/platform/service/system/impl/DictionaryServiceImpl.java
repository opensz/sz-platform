...
import org.sz.platform.dao.system.DictionaryDao;
import org.sz.platform.dao.system.GlobalTypeDao;
...
import org.sz.platform.service.system.DictionaryService;
 ...
 public class DictionaryServiceImpl extends BaseServiceImpl<Dictionary> implements DictionaryService
 {
   ...
   {
     return this.dictionaryDao.isItemKeyExistsForUpdate(dicId, typeId, itemKey);
   }
