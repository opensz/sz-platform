...
public class DesttopMycolumn extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.ID, rhs.ID)
				...
				.append(this.COLUMNNUM, rhs.COLUMNNUM).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.ID)
				.append(this.USERID).append(this.COLUMNID)
				.append(this.COLUMNNUM).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("ID", this.ID)
				...
				.append("COLUMNNUM", this.COLUMNNUM).toString();
	}
}
