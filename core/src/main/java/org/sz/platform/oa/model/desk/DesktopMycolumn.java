...
public class DesktopMycolumn extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.id, rhs.id)
				...
				.append(this.columnId, rhs.columnId).append(this.col, rhs.col)
				.append(this.sn, rhs.sn).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.id)
				.append(this.userId).append(this.layoutId)
				.append(this.columnId).append(this.col).append(this.sn)
				.toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", this.id)
				...
				.append("columnId", this.columnId).append("col", this.col)
