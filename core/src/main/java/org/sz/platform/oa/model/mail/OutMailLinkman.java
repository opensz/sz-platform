...
public class OutMailLinkman extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.linkId, rhs.linkId)
				.append(this.mailId, rhs.mailId)
				.append(this.sendTime, rhs.sendTime)
				.append(this.linkName, rhs.linkName)
				.append(this.linkAddress, rhs.linkAddress).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.linkId)
				.append(this.mailId).append(this.sendTime)
				.append(this.linkName).append(this.linkAddress).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("linkId", this.linkId)
				.append("mailId", this.mailId)
				.append("sendTime", this.sendTime)
				.append("linkName", this.linkName)
				.append("linkAddress", this.linkAddress).toString();
	}
}
