...
public class DesktopColumnServiceImpl extends BaseServiceImpl<DesktopColumn>
		implements DesktopColumnService {
	...
	public void addDesktopColumn(long userId) throws Exception {
		String templatePath = getTemplatePath();
		String xml = FileUtil.readFile(templatePath + "desktop"
				+ File.separator + "desktop.xml");
		...
		for (Element element : list) {
			...
			Integer isSys = Integer.valueOf(Integer.parseInt(element
					.attributeValue("isSys")));
			String fileName = templateId + ".ftl";
			String html = FileUtil.readFile(templatePath + "desktop"
