...
public class CalendarSetting extends BaseModel {
	...
	public String getCalDay() {
		return new StringBuilder()
				.append(this.years)
				.append("-")
				.append(this.months.shortValue() < 10 ? new StringBuilder()
						.append("0").append(this.months).toString()
						: this.months)
				.append("-")
				.append(this.days.shortValue() < 10 ? new StringBuilder()
						.append("0").append(this.days).toString() : this.days)
				.toString();
	}
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.calendarId, rhs.calendarId)
				.append(this.years, rhs.years).append(this.months, rhs.months)
				.append(this.days, rhs.days).append(this.type, rhs.type)
				.append(this.workTimeId, rhs.workTimeId).isEquals();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", this.id)
				...
				.append("years", this.years).append("months", this.months)
				.append("days", this.days).append("type", this.type)
				.append("workTimeId", this.workTimeId).toString();
	}
}
