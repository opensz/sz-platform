...
public class SysRole extends BaseModel implements GrantedAuthority, Cloneable {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.roleId, rhs.roleId)
				...
				.append(this.allowDel, rhs.allowDel)
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.roleId)
				.append(this.systemId).append(this.alias).append(this.roleName)
				.append(this.memo).append(this.allowDel).append(this.allowEdit)
				.append(this.enabled).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("roleId", this.roleId)
				.append("systemId", this.systemId).append("alias", this.alias)
				.append("roleName", this.roleName).append("memo", this.memo)
