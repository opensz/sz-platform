...
public class ResourcesUrlDaoImpl extends BaseDaoImpl<ResourcesUrl> implements
		ResourcesUrlDao {
	...
	public List<ResourcesUrlExt> getUrlAndRoleBySystemId(long systemId) {
		String statment = getIbatisMapperNamespace()
				+ ".getUrlAndRoleBySystemId";
		return getSqlSessionTemplate().selectList(statment,
