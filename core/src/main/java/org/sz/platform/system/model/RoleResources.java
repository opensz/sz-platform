...
public class RoleResources extends BaseModel implements Cloneable {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.roleResId, rhs.roleResId)
				.append(this.roleId, rhs.roleId).append(this.resId, rhs.resId)
				.isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973)
				.append(this.roleResId).append(this.roleId).append(this.resId)
				.toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("roleResId", this.roleResId)
				.append("roleId", this.roleId).append("resId", this.resId)
				.toString();
	}
