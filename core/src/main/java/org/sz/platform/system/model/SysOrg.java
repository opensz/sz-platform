...
public Long getSupplierType() {
	...
	public boolean equals(Object object)
   {
     ...
     return new EqualsBuilder().append(this.orgId, rhs.orgId).append(this.demId, rhs.demId).append(this.orgName, rhs.orgName).append(this.orgDesc, rhs.orgDesc).append(this.orgSupId, rhs.orgSupId).append(this.path, rhs.path).append(this.depth, rhs.depth).append(this.orgType, rhs.orgType).append(this.creatorId, rhs.creatorId).append(this.createtime, rhs.createtime).append(this.updateId, rhs.updateId).append(this.updatetime, rhs.updatetime).append(this.ownUser, rhs.ownUser).append(this.sn, rhs.sn).isEquals();
   }
 
   public int hashCode()
   {
     return new HashCodeBuilder(-82280557, -700257973).append(this.orgId).toHashCode();
   }
 
   public String toString()
   {
     return new ToStringBuilder(this).append("orgId", this.orgId).append("demId", this.demId).append("orgName", this.orgName).toString();
   }
 }
