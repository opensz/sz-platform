...
import org.sz.core.model.BaseModel;
 ...
 public class UserPosition extends BaseModel
 {
   ...
   public boolean equals(Object object)
   {
     ...
     return new EqualsBuilder().append(this.userPosId, rhs.userPosId).append(this.posId, rhs.posId).append(this.userId, rhs.userId).append(this.isPrimary, rhs.isPrimary).isEquals();
   }
 
   public int hashCode()
   {
     return new HashCodeBuilder(-82280557, -700257973).append(this.userPosId).append(this.posId).append(this.userId).append(this.isPrimary).toHashCode();
   }
 
   public String toString()
   {
     return new ToStringBuilder(this).append("userPosId", this.userPosId).append("posId", this.posId).append("userId", this.userId).append("isPrimary", this.isPrimary).toString();
   }
 }
