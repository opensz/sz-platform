...
public class Message extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.messageId, rhs.messageId)
				.append(this.subject, rhs.subject)
				.append(this.receiver, rhs.receiver)
				.append(this.copyTo, rhs.copyTo).append(this.bcc, rhs.bcc)
				.append(this.fromUser, rhs.fromUser)
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973)
				.append(this.messageId).append(this.subject)
				.append(this.receiver).append(this.copyTo).append(this.bcc)
				.append(this.fromUser).append(this.templateId)
				.append(this.messageType).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("messageId", this.messageId)
				.append("subject", this.subject)
				.append("receiver", this.receiver)
				.append("copyTo", this.copyTo).append("bcc", this.bcc)
