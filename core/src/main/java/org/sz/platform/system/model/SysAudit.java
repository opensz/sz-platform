...
public class SysAudit extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.auditId, rhs.auditId)
				...
				.append(this.reqParams, rhs.reqParams).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.auditId)
				.append(this.opName).append(this.exeTime)
				.append(this.executorId).append(this.executor)
				.append(this.fromIp).append(this.exeMethod)
				.append(this.requestURI).append(this.reqParams).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("auditId", this.auditId)
				.append("opName", this.opName).append("exeTime", this.exeTime)
				...
				.append("reqParams", this.reqParams).toString();
	}
}
