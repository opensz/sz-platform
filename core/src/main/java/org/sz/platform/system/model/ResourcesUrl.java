...
public class ResourcesUrl extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.resUrlId, rhs.resUrlId)
				.append(this.resId, rhs.resId).append(this.name, rhs.name)
	...
	public String toString() {
		return new ToStringBuilder(this).append("resUrlId", this.resUrlId)
				.append("resId", this.resId).append("name", this.name)
