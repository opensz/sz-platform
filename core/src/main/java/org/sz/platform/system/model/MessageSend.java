...
public class MessageSend extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.id, rhs.id)
				...
				.append(this.receiverName, rhs.receiverName).isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.id)
				.append(this.subject).append(this.userId).append(this.userName)
				.append(this.messageType).append(this.content)
				.append(this.sendTime).append(this.canReply)
				.append(this.receiverName).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("id", this.id)
				.append("subject", this.subject).append("userId", this.userId)
				.append("userName", this.userName)
				.append("messageType", this.messageType)
				.append("content", this.content)
				.append("sendTime", this.sendTime)
				.append("canReply", this.canReply)
				.append("receiverName", this.receiverName).toString();
	}
}
