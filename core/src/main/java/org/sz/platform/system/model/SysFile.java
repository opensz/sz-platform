...
public class SysFile extends BaseModel {
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.fileId)
				.append(this.typeId).append(this.fileName)
				.append(this.filePath).append(this.createtime).append(this.ext)
				.append(this.fileType).append(this.note).append(this.creatorId)
				.append(this.creator).append(this.totalBytes)
				.append(this.delFlag).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("fileId", this.fileId)
				...
				.append("fileType", this.fileType).append("note", this.note)
