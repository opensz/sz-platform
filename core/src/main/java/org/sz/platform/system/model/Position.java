...
public class Position extends BaseModel {
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.posId)
				...
				.append(this.parentId).append(this.nodePath).append(this.depth)
				.append(this.sn).append(this.isPrimary).toHashCode();
	}

	public String toString() {
		return new ToStringBuilder(this).append("posId", this.posId)
				.append("posName", this.posName)
				.append("posDesc", this.posDesc)
				.append("parentId", this.parentId)
				.append("nodePath", this.nodePath).append("depth", this.depth)
				.append("sn", this.sn).append("isPrimary", this.isPrimary)
				.toString();
	}
}
