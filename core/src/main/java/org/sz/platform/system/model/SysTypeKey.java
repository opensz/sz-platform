...
public class SysTypeKey extends BaseModel {
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder().append(this.typeId, rhs.typeId)
				...
				.append(this.typeName, rhs.typeName).append(this.sn, rhs.sn)
				.isEquals();
	}

	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.typeId)
				.append(this.typeKey).append(this.typeName).append(this.sn)
				.toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("typeId", this.typeId)
				...
				.append("typeName", this.typeName).append("sn", this.sn)
				.toString();
	}
}
