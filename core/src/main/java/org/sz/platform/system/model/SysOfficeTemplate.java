...
public class SysOfficeTemplate extends BaseModel {
	...
	public int hashCode() {
		return new HashCodeBuilder(-82280557, -700257973).append(this.id)
				.append(this.subject).append(this.templatetype)
				.append(this.memo).append(this.creatorid).append(this.creator)
				.append(this.createtime).append(this.path).toHashCode();
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("id", this.id)
				...
				.append("memo", this.memo).append("creatorid", this.creatorid)
