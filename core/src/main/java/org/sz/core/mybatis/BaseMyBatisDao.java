...
import org.springframework.util.Assert;
 ...
 public abstract class BaseMyBatisDao extends DaoSupport
 {
   ...
   public IbatisSql getIbatisSql(String id, Object parameterObject)
   {
     ...
     Collection coll = this.sqlSessionFactory.getConfiguration().getMappedStatementNames();
     ...
     if (parameterMappings != null) {
       ...
       MetaObject metaObject = parameterObject == null ? null : MetaObject.forObject(parameterObject, objectFactory, objectWrapperFactory);
         ...
         else
         {
           ...
           else
           {
             ...
             } else if ((propertyName.startsWith("__frch_")) && (boundSql.hasAdditionalParameter(prop.getName())))
             {
               ...
               if (value != null)
                 value = MetaObject.forObject(value, objectFactory, objectWrapperFactory).getValue(propertyName.substring(prop.getName().length()));
             }
             else {
   ...
   public static class SqlSessionTemplate
   {
     ...
     public int insert(final String statement, final Object parameter)
     {
       return ((Integer)execute(new BaseMyBatisDao.SqlSessionCallback() {
         public Object doInSession(SqlSession session) {
           return Integer.valueOf(session.insert(statement, parameter));
         }
       })).intValue();
     }
     ...
     public int delete(final String statement, final Object parameter)
     {
       return ((Integer)execute(new BaseMyBatisDao.SqlSessionCallback() {
         public Object doInSession(SqlSession session) {
           return Integer.valueOf(session.delete(statement, parameter));
         }
       })).intValue();
     }
     ...
     public int update(final String statement, final Object parameter)
     {
       return ((Integer)execute(new BaseMyBatisDao.SqlSessionCallback() {
         public Object doInSession(SqlSession session) {
           return Integer.valueOf(session.update(statement, parameter));
         }
       })).intValue();
     }
