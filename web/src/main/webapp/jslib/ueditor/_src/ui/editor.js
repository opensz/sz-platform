                ...
                editor.addListener('mouseover', function (t, evt) {
                    ...
                    if(ifEl || ifElParent){
    	    			html = popup.formatHtml(
	                       '<nobr>' + editor.getLang("property") + ': <span onclick="$$._onInputDelButtonClick()" class="edui-clickable">' + editor.getLang("delete") + '</span></nobr>');
			 			if(editor.options.editorModel && editor.options.editorModel=="designModel"){
		 					html = popup.formatHtml(
	                    ...
	                    if(el.tagName == "INPUT"){
	                        html = popup.formatHtml(
	                                '<nobr>' + editor.getLang("property") + ': <span onclick=$$._onInputDelButtonClick() class="edui-clickable">' + editor.getLang("delete") + '</span>&nbsp;&nbsp;&nbsp;&nbsp;'+   
	                                '<span onclick="$$._onInputEditButtonClick(event, this);" class="edui-clickable">修改</span>&nbsp;&nbsp;</nobr>');//+
	                        		//'<span onclick="$$._onInputDialogButtonClick(event, this);" class="edui-clickable">自定义对话框</span></nobr>' );
	                    }
                    }
                    if (html) {
