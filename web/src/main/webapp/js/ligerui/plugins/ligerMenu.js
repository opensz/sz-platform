...
(function ($)
{
    ...
    $.ligerMenu = function (p)
    {
        ...
        var g = {
            ...
            removeAll:function(){
            	$("> .l-menu-item", g.menu.items).remove();
            	g.itemCount=0;
            },
            ...
            hideAllSubMenu:function(menu)
            {
                ...
                $("> .l-menu-item",menu.items).each(function(){
                    if($("> .l-menu-item-arrow",this).length>0)
                    {
                        ...
                        //隐藏iframe
                        g.hideIframe(LigerUIMenu[meniitemid]);
                    }
                });
        ...
        //var iframeObj=$("iframe.l_menu_frame",g.menu);
        g.menu.css({ top: p.top, left: p.left, width: p.width });  
        
        
        //iframeObj.css({ top: p.top, left: p.left, width: p.width ,height:g.menu.height()});
        ...
        //g.iframe.css({ top: p.top, left: p.left, width: p.width+2,height:g.menu.height()+5 });
        return g;
    };
