...
{	
	var url=__ctx + "/platform/bpm/bpmNodeRule/edit.xht?deployId="+conf.deployId+"&actDefId=" + conf.actDefId +"&nodeId=" + conf.nodeId+"&nodeName=" +encodeURIComponent(conf.nodeName);
