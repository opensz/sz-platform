...
function FlowVarWindow(conf)
{
	...
	var url;
	if(conf.defId!=null){
		url=__ctx + "/platform/bpm/bpmDefVar/getByDeployNode.xht?defId="+conf.defId;
	}else{
		url=__ctx + "/platform/bpm/bpmDefVar/getByDeployNode.xht?deployId="+conf.deployId+"&nodeId=" + conf.nodeId;
	}
	var dialogWidth=500;
