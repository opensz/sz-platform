Namespace.register("org.sz.platform.system");
/**
 * 表达式计算。
 * var con=org.sz.platform.system.ConditionExpression();
 * 计算节点
 * con.evaluate(node);
 * 获取结果
 * con.getResult();
 * 清除计算
 * con.clear();
 * @returns {org.sz.platform.system.ConditionExpression}
 */
org.sz.platform.system.ConditionExpression = function(){
	{
