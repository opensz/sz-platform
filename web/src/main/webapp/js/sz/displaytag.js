...
function goPage(n,tableIdCode){
	location.href=replacecurrentPage($("#_nav"+tableIdCode).attr('href'),n,tableIdCode);
}
...
function changePageSize(sel,tableIdCode){
	location.href=replagePageSize($("#_nav"+tableIdCode).attr('href'),sel.value,tableIdCode);
}
/**
 * 跳转至第n页
 */
