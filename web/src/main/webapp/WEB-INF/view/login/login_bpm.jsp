...
<script type="text/javascript"
	src="${ctx}/jslib/jquery/jquery-1.7.2.min.js"></script>
...
<script type="text/javascript">
			...
			if(top!=this){//当这个窗口出现在iframe里，表示其目前已经timeout，需要把外面的框架窗口也重定向登录页面
				  top.location='<%=request.getContextPath()%>/login/login_bpm.xht';
			}
				    ...
				    success: function(data) {
				    	var msg=data['msg'];
				     	if(msg!=""){
				     		...
				     		$("#form-login").action="<%=request.getContextPath()%>
	/login.xht";
									$("#form-login").submit();
								}
							}
...
<body>
	<div class="second_body01">
		<form id="form-login" action="<%=request.getContextPath()%>/login.xht"
			method="post">
			...
			<table width="300" border="0">
				...
				<tr align="center">
					<td colspan="3"><input type="button" value="登录"
						class="login_button" onclick="checkUser();" /><input type="button"
						value="重置" class="reset_botton" onclick="this.form.reset();">
					</td>
				</tr>
				<%
				...
				%>
				<tr>
					<td align="center" colspan="3"><font color="red"><div
								id="msg"></div>
					</font></td>
				</tr>
