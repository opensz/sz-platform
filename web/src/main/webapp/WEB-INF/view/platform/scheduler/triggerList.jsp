		...
		<div class="panel">
				<div class="panel-top">
					...
					<div class="panel-toolbar">
						<div class="toolBar">
							<div class="group"><a class="link add" href="addTrigger1.xht?jobName=${jobName}">添加</a></div>
							<div class="l-bar-separator"></div>
							<div class="group"><a class="link back"  href="getJobList.xht">返回</a></div>
						</div>	
					</div>
				</div>
					...
					<div class="panel-data">
					    ...
					    <%
							...
							for(int i=0;i<list.size();i++)
							{
								...
								String toggleUrl="toggleTriggerRun.xht?name=" + trigName ;
								String delTrigger="delTrigger.xht?name="+trigName ;
								String logList="getLogList.xht?trigName="+trigName+"&jobName="+jobName;
			 			%>
