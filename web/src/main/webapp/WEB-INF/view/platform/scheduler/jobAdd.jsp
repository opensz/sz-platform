	...
	<head>
		...
		valid=$("#jobForm").validate({
			rules: {
				...
				className:{required:true,maxlength:128}
			},
			messages: {
				name:{required:"任务名称必填.",maxlength:"任务名称 最多 50 个字符."},
				className:{required:"任务类必填.",maxlength:"任务类 最多 50个字符."
				}
			},
...
<body>
		<div class="panel">
			...
			<form id="jobForm" method="post" action="addJob2.xht">
