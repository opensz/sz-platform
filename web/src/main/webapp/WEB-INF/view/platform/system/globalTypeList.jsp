...
<head>
	...
	<script type="text/javascript">
		function addNew(parentId,catKey,returnUrl,type)
		{
			...
			{
				location.href="add1.xht?parentId="+parentId+"&catKey="+catKey+"&type="+type+"&returnUrl="+returnUrl;
			}
		}
	</script>
</head>
				...
				<div class="panel-body">
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.xht">
									<div class="row">
												<span class="label">名称:</span><input type="text" name="Q_typeName_S"  class="inputText" />
					...
					<div class="panel-data">
					    ...
					    <display:table name="globalTypeList" id="globalTypeItem" requestURI="list.xht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
							...
							<display:column title="管理" media="html" style="width:180px;">
								<a href="del.xht?typeId=${globalTypeItem.typeId}" class="link del">删除</a>
								<a href="upd1.xht?typeId=${globalTypeItem.typeId}&returnUrl=${returnUrl}" class="link edit">编辑</a>
								<a href="get.xht?typeId=${globalTypeItem.typeId}" class="link detail">明细</a>
							</display:column>
						</display:table>
						<sz:paging tableId="globalTypeItem"/>
					</div>
