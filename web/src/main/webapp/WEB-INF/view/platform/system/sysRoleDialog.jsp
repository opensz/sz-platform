...
<html>
	<head>
		...
		<script type="text/javascript">
			var systemTree=null;
			$(function(){
				$("#defLayout").ligerLayout({ leftWidth: 210,height: '90%',minLeftWidth:220});
				loadTree();
			});
			...
			function loadTree(){
		    		...
		    		$.ajax({
		    			type: 'POST',
		    			url:"${ctx}/platform/system/subSystem/tree.xht",
			...
			function treeClick(event, treeId, treeNode){
        		var url="${ctx}/platform/system/sysRole/selector.xht?Q_systemId_L="+getSelectNode();
	...
	<body style="overflow: hidden;">
			<div id="defLayout" >
	            ...
	            <div position="center">
	          		<iframe id="roleFrame" name="roleFrame" height="100%" width="100%" frameborder="0"  src="${ctx}/platform/system/sysRole/selector.xht"></iframe>
	            </div>  
       	  </div>
