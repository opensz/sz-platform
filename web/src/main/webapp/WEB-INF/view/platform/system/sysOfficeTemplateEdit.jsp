...
<head>
	...
	<script type="text/javascript">
		$(function() {
			...
			var id=$("#officeTemplateId").val();
			$("a.save").click(function() {
			    if($("#file").val()==''&&!id){
					$.ligerMessageBox.error("提示","请上传模板文件");
				}else{
		...
		function showResponse(responseText){
			...
			if(obj.isSuccess()){
				$.ligerMessageBox.success("提示",obj.getMessage(),function(){
						window.location.href="list.xht";
				});
			}else{
				$.ligerMessageBox.error("提示",obj.getMessage());
			}
		}
	</script>
</head>
...
<div class="panel">
		...
		<div class="panel-body">
				<form id="sysOfficeTemplateForm" method="post" action="saveTemplate.xht">
					...
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							<th width="20%">路径: </th>
							<td><input type="file" id="file" name="path" style="width: 200px;" class="inputText" value="${sysOfficeTemplate.path}"/></td>
						</tr>
						<tr>
							<th width="20%">备注: </th>
							<td>
