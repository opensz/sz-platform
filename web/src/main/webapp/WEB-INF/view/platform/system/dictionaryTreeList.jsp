	...
	<script type="text/javascript">
		...
		function addNew(){
			...
			if(typeId==0){
				...
				location.href="add1.xht?typeId="+typeId;
			}
		}
	</script>
</head>
				    	...
				    	<c:forEach items="${dictionaryList}" var="dictionaryItem" varStatus="status">
				    		<tr id="${dictionaryItem.dicId }" parentId="${dictionaryItem.parentId }" class="${status.index%2==0?'even':'odd'}">
				    			...
				    			<td nowrap="nowrap" style="width:415px;">
									...
									<a href="add1.xht?typeId=${typeId}&parentId=${dictionaryItem.dicId}&returnUrl=${returnUrl}" class="link-add"><span class="link-btn">添加子结点</span></a>
