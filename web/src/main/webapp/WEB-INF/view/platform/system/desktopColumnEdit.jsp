				...
				<table class="table-detail" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td><input type="text" id="name" name="name"
							style="width: 20%;" value="${desktopColumn.name}"
							class="inputText" style="width: 80%;" /></td>
					</tr>
					<tr>
						<th width="20%">方法路径:</th>
						<td><input type="text" id="serviceMethod"
							name="serviceMethod" style="width: 40%;"
							value="${desktopColumn.serviceMethod}" class="inputText"
							style="width: 80%;" />
						</td>
					</tr>
					<tr>
						<th width="20%">更多路径:</th>
						<td><input type="text" id="columnUrl" name="columnUrl"
							style="width: 40%;" value="${desktopColumn.columnUrl}"
							class="inputText" style="width: 80%;" />(注：为空则不在工作台页面显示"more"图标)</td>
					</tr>
					<tr>
						<th width="20%">模板html:</th>
						<td><textarea id="html" name="html" cols=100 rows=20>${desktopColumn.html}</textarea>
						</td>
					</tr>
				</table>
