...
<script type="text/javascript">
        	...
        	function addNode()
        	{
        		orgTree = $.fn.zTree.getZTreeObj("orgTree");
         		...
         		var url="edit.xht?orgId="+orgId+"&demId="+demId+"&flag=TA";
        	...
        	function editNode()
        	{
        		orgTree = $.fn.zTree.getZTreeObj("orgTree");
       			...
       			var orgId=treeNode.orgId;//如果是新增时它就变成父节点Id	      
       			var demId=treeNode.demId;
         		var url="edit.xht?orgId="+orgId+"&demId="+demId+"&flag=TE";
         		parent.$("#viewFrame").attr("src", url);          		
        	};
        	...
        	function zTreeBeforeClick(treeId, treeNode, clickFlag){
         	...
         	//左击事件
       		function zTreeOnLeftClick(event, treeId, treeNode){   
       			...
       			var demId=treeNode.demId;
       			parent.$("#viewFrame").attr("src","get.xht?path="+path+"&orgId="+orgId+"&demId="+demId);
       		};
           ...
           //生成树      		
       	   function loadTree(selid){
       			...
       			$.post("${ctx}/platform/system/sysOrg/getTreeData.xht?demId="+selid,
       				function(result){
       					orgTree=$.fn.zTree.init($("#orgTree"), setting,eval(result));
        	...
        	function sortType(orgIds){
        		$.post("${ctx}/platform/system/sysOrg/sort.xht?orgIds="+orgIds,
        			function(result){
