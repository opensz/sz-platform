<%@ page language="java" contentType="text/html; charset=UTF-8" import="org.sz.platform.system.model.SysParam"
    pageEncoding="UTF-8"%>
...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/sz/platform/system/ConditionExpression.js"></script>
	...
	var zNodes=eval('${cmpIds}');
	$(document).ready(function(){
		_dataType = $("#paramKey").find("option:selected").attr("title");
		$("a.save").click(function(){
			save();
		});
		zTree=$.fn.zTree.init($("#treeCondition"), setting,zNodes);
		//表达式计算JS。
		conditionExpress=new org.sz.platform.system.ConditionExpression();
	...
	function preview(){
		...
		var url=__ctx + '/platform/system/sysOrgParam/getByParamKey.xht?orgParam='+orgParam;
		url=url.getNewUrl();
...
<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
	...
	<tr height="100px">
		...
		<td  valign="top">
			...
			<textarea rows="6" cols="75" id="txtCondition">${cmpNames}</textarea>
			<textarea  style="display: none;" rows="6" cols="75" id="valCondition">${cmpIds}</textarea>
		</td>
	</tr>
</table>
</div>
