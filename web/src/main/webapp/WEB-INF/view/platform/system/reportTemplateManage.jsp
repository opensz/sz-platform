...
<script type="text/javascript">
	...
	//var url="${ctx}/platform/system/globalType/getByCatKey.xht";
	...
	var globalType=new GlobalType(catKey,"glTypeTree",{onClick:treeClick,onRightClick:zTreeOnRightClick});
	...
	function treeClick(treeNode) {
		...
		var url = "${ctx}/platform/system/reportTemplate/list.xht";
		if(parentId!=null){
			url += "?typeId=" + typeId;
		}
...
<body>
    ...
    <div id="defLayout" >
		...
		<div position="center" title="报表管理">
			<iframe id="reportFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/system/reportTemplate/list.xht"></iframe>
		</div>
     </div>
