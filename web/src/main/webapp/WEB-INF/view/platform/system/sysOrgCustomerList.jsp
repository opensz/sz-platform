...
<script type="text/javascript">
	...
	function zTreeOnLeftClick(event, treeId, treeNode) {
		...
		$("#viewFrame").attr("src", "customerSelector.xht?demId=1&path=" + orgId);
	};
	...
	function delNode() {
		...
		$.ligerMessageBox.confirm('提示信息', "确认要删除此客户吗？", callback);
...
<body>
	...
	<div id="layout" style="bottom: 1; top: 1">
		<div position="left" title="客户管理" id="rogTree"
		...
		<div position="center" id="orgView" style="height: 100%;">
			<div class="l-layout-header">客户管理信息</div>
			<iframe id="viewFrame" src="customerSelector.xht?demId=1" frameborder="0" width="100%" height="100%"></iframe>
		</div>
	</div>
