...
<div class="panel">
		...
		<div class="panel-body">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					<th width="20%">回复信息:</th>
					<td colspan="3"><a href="${ctx}/platform/system/messageReply/list.xht?messageId=${messageSend.id}&userId=${messageSend.userId}">查看回复信息</a></td>
				</tr>
				</c:if>
			...
			<iframe id="detailFrame" height="100%" width="100%" frameborder="0" onload="javascript:dyniframesize('detailFrame')"
				src="readDetail.xht?id=${messageSend.id}&canReply=${messageSend.canReply}"></iframe>
