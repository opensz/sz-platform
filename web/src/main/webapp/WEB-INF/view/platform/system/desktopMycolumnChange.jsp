...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/sz/platform/desktop/desktopTemplete.js" ></script>
	<script type="text/javascript">
		...
		function save(){
			...
			org.sz.platform.desktop.saveCol(layoutID,"desktopMycolumn",layoutCols);
		}
		$(function () { 
			var desktop="${desktop}";
			...
			new org.sz.platform.desktop.myTemp(cols,columnId,width,1,desktop);
	...
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<div class="group">
					<a class="link back" href="../desktopMycolumn/show.xht">返回</a>
				</div>
				<div class="l-bar-separator"></div>				
				<div class="group">
					<a class="link undo" href="../desktopMycolumn/news.xht?id=${desktopLayoutmap.id}">重置布局</a>
				</div>
				<div class="l-bar-separator"></div>	
				<div class="group">
