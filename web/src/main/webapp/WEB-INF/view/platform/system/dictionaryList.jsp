	...
	<script type="text/javascript">
		...
		function reSortListSn(trObj,url){
			...
			if(dicIds.length>1){
				...
				form.creatForm("form", "${ctx}/platform/system/dictionary/sort.xht");
		...
		function addNew(parentId,typeId,returnUrl)
		{
			...
			{
				location.href="add1.xht?typeId="+typeId+"&returnUrl="+returnUrl;
			}
		}
			...
			<div class="panel">
				...
				<div class="panel-body">
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.xht">
									<div class="row">
												...
												<span class="label">项Key:</span><input type="text" name="itemKey"  class="inputText" />
											
												<span class="label">项名:</span><input type="text" name="itemName"  class="inputText" />
					...
					<div class="panel-data">
					    ...
					    <display:table name="dictionaryList" id="dictionaryItem" requestURI="list.xht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
							...
							<display:column title="管理" media="html" style="width:300px;">
								<a href="del.xht?dicId=${dictionaryItem.dicId}" class="link del">删除</a>
								<a href="upd1.xht?dicId=${dictionaryItem.dicId}&returnUrl=${returnUrl}" class="link edit">编辑</a>
								<a href="get.xht?dicId=${dictionaryItem.dicId}" class="link detail">明细</a>
