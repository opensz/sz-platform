...
<head>
	...
	<script type="text/javascript" src="${ctx}/jslib/ckeditor/ckeditor_msg.js"></script>
		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a class="link back" href="list.xht?userId=${userId}">返回</a></div>
				</div>
			</div>
		</div>
		<div class="panel-body">
				<form id="messageSendForm" method="post" action="save.xht">
