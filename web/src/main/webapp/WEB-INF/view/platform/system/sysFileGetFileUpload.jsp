<%@page import="org.sz.core.web.util.RequestUtil"%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
<%@ page import="org.sz.core.util.ContextUtil" %>
...
<html>
  ...
  <style type="text/css"> 
	...
	#flashContent { display:none; }
       ...
       var uploadPath="${ctx}/platform/system/sysFile/fileUpload.xht;jsessionid=<%=session.getId()%>?typeId=<%=typeId%>" ;
       var delPath="${ctx}/platform/system/sysFile/delByFileId.xht;jsessionid=<%=session.getId()%>" ;
       
       function initFlashUpload(){
      	   //设置swfobject对象参数
      	   var swfVersionStr = '10.0.0';
           var xiSwfUrlStr = '${ctx}/media/swf/common/playerProductInstall.swf';
           var flashvars = {};
