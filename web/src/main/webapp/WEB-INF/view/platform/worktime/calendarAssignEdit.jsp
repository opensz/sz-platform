...
<head>
	...
	<script type="text/javascript" src="${ctx}/servlet/ValidJs?form=calendarAssign"></script>
...
<div class="panel">
	...
	<div class="panel-body">
		<form id="calendarAssignForm" method="post" action="save.xht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
				<tr>
					<th width="20%">工作日历: </th>
					<td>
						<select id="canlendarId" name="canlendarId" style="width: 10%;">
				...
				<tr>
					...
					<td>
					<select id="assignType" name="assignType" style="width: 10%;" onchange="changeOrgOrUser(value)">
				...
				<tr>
					...
					<td>
						<ul>
							<li style="float: left;">
								<textarea rows="5" cols="60" id="assUserName" name="assUserName" readonly="readonly"
									class="inputText">
									${calendarAssign.assignUserName}
								</textarea>
								<input type="hidden" id="assignUserName" name="assignUserName" value="${calendarAssign.assignUserName}" />
								<input type="hidden" id="assignUid" name="assignUid" value="${calendarAssign.assignId}" />
							</li>
