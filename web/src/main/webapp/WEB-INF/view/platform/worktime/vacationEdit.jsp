...
<head>
	...
	<script type="text/javascript" src="${ctx}/servlet/ValidJs?form=vacation"></script>
...
<div class="panel">
		...
		<div class="panel-body">
				<form id="vacationForm" method="post" action="save.xht">
					<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
						<tr>
							<th width="20%">假日名称: </th>
							<td><input type="text" id="name" name="name" value="${vacation.name}"  class="inputText"/></td>
						</tr>
						<tr>
							<th width="20%">年份: </th>
							<td>
								<c:if test="${vacation.years==null}">
									<input type="text" id="years" name="years" value="${year}"  class="inputText"/>
								</c:if>
								<c:if test="${vacation.years!=null}">
									<input type="text" id="years" name="years" value="${vacation.years}"  class="inputText"/>
								</c:if>
							</td>
						</tr>
						<tr>
