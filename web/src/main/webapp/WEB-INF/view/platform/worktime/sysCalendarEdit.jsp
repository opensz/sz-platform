...
<head>
	...
	<link href="${ctx}/themes/css/worktimeCalendar/calendar.css" rel="stylesheet" type="text/css" />
	<script type="text/javascript">
		...
		function jumpTo(flag,year,month){
			var url = 'edit.xht?id=${sysCalendar.id}&wtYear='+year+'&wtMon='+month;
			if(flag=='pre'){
...
<div class="panel">
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				...
				<div class="l-bar-separator"></div>
				<div class="group">
					<form id="searchForm" method="post" action="edit.xht">
						<ul>
	...
	<div class="panel-body">
		...
		<form id="sysCalendarForm" method="post" action="save.xht">
			<input type="hidden" name="id" value="${sysCalendar.id}" />
