...
<head>
	...
	<script type="text/javascript" src="${ctx}/js/sz/platform/form/Relation.js"></script>
	<script type="text/javascript">
		...
		var relationObj=new org.sz.platform.form.Relation();
		...
		function changeTable(){
			...
			if(tabName=="") return;
			var url="getByTable.xht".getNewUrl();
...
<body>
<form id="relationForm" method="post" action="save.xht">
	<div class="panel">
			<div class="panel-top">
