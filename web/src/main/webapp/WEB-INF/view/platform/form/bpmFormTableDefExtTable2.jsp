...
<script type="text/javascript">
	...
	$(function(){
		...
		$.get("getTableModel.xht",{dataSource:dataSource,tableName:tableName},function(data){
			bindExtTable(data);
			table=data.table;
		});
	...
	function handSave(){
		$("#dataFormSave").click(function(){
			...
			$.post("saveExtTable.xht",{table:tableJson,fields:fieldJson},showResponse);
		});
	}
		...
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					...
					<div class="group"><a class="link back" href="defExtTable1.xht">返回</a></div>
				</div>
			</div>
		</div>
		<br>
