...
<script type="text/javascript" src="${ctx}/jslib/lg/plugins/ligerSpinner.js"></script>
...
<script type="text/javascript" src="${ctx}/js/sz/platform/form/formTable.js" ></script>
<script type="text/javascript">
	...
	$(function ()
	{
		...
		$.post('getTableByTableId.xht?tableId=${tableId}', function(data) {
			
			tableManager = new org.sz.platform.form.TableManager({
				id: {
...
<body>
	<div class="panel-top">
		...
		<div class="panel-toolbar">
			<div class="toolBar">
				<div class="group"><a class="link save" id="dataFormSave" url="save.xht" onclick="save(this)">保存</a></div>
