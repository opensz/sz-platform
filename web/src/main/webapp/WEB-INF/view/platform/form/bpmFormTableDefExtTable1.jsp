...
<head>
	...
	<script type="text/javascript">
		...
		function handNextClick(){
			...
			$.get("isTableNameExternalExisted.xht",parameter, function(data) {
				if(data=="true"){
		...
		function searchTables(){
			...
			var url=__ctx +"/platform/form/bpmFormTable/getTableList.xht";
...
<div class="panel">
		...
		<div class="panel-body">
				<form id="scriptForm" method="post" action="defExtTable2.xht">
