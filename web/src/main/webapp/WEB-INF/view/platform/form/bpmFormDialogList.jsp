			...
			<div class="panel">
				...
				<div class="panel-body">
					...
					<div class="panel-data">
					    ...
					    <display:table name="bpmFormDialogList" id="bpmFormDialogItem" requestURI="list.xht" sort="external" cellpadding="1" cellspacing="1"   class="table-grid">
							...
							<display:column title="管理" media="html" style="width:180px">
								<a href="del.xht?id=${bpmFormDialogItem.id}" class="link del">删除</a>
								<a href="edit.xht?id=${bpmFormDialogItem.id}" class="link edit">编辑</a>
								<a href="javascript:preview('${bpmFormDialogItem.alias}')"  class="link detail">预览</a>
							</display:column>
						</display:table>
						<sz:paging tableId="bpmFormDialogItem"/>
					</div>
