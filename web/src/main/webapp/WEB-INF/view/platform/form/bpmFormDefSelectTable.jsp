	...
	<div class="panel">
		...
		<div class="panel-body">
			...
			<div class="panel-data">
			    <display:table name="bpmFormTableList" id="bpmFormTableItem" requestURI="list.xht" sort="external" cellpadding="1" cellspacing="1" export="false"  class="table-grid">
					...
					<display:column title="选择">
						<a href="edit.xht?tableId=${bpmFormTableItem.tableId}" class="link get" target="_parent">选择</a>
					</display:column>
				</display:table>
