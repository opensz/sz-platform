	...
	<div id="defLayout">
		<div position="top" title="选择自定义表" >
			...
			<div class="panel-search">
				<form id="searchForm" method="post" action="dialog.xht">
				
						<span class="label">表名:</span><input type="text" name="Q_tableName_S"  class="inputText" size="10" />
						<span class="label">描述:</span><input type="text" name="Q_tableDesc_S"  class="inputText" size="10" />
						...
						<span class="label">数据源:</span><input type="text" name="Q_dsAlias_S"  class="inputText" size="10" />
				
				</form>
			</div>
		</div>
		<div position="center"  style="overflow: auto;">
	    	<display:table name="bpmFormTableList" id="bpmFormTableItem" requestURI="list.xht" sort="external"  export="false"  class="table-grid">
				<display:column  title="表名" style="text-align:left">
