...
<script type="text/javascript">
	...
	function selectSubTable() {
		if(!winIframe) {
			$.post('getAllUnassignedSubTable.xht', {
			...
			<div class="panel-data">
			 	<table class="table-grid">
					<tr>
						...
						<td><a href="#" onclick="parent.showDetail('get.xht?iswin=1&tableId=${table.tableId}')" class="link detail">查看</a></td>
					</tr>
					...
					<c:forEach items="${subTables}" var="subTable"  varStatus="status">
						<tr>
							...
							<td>
								<a href="#" onclick="parent.showDetail('get.xht?iswin=1&tableId=${subTable.tableId}')" class="link detail">查看</a>
								<a href="unlinkSubTable.xht?subTableId=${subTable.tableId}" class="link del" onclick="parent.needRefresh = true">移除</a>
							</td>
						</tr>
					</c:forEach>
				</table>
