...
<c:set var="ctx" value="${pageContext.request.contextPath}" />
	<div class="panel-top">
			<table class="table-detail">
				...
				<tr>
					<th nowrap="nowrap">会签投票(*)</th>
					<td>
						同意<input type="radio" name="voteAgree" value="1" checked="checked">&nbsp;
						反对<input type="radio" name="voteAgree" value="2">&nbsp;
						弃票<input type="radio" name="voteAgree" value="0">
						<div id="agreeTip" style="width:280px"></div>
					</td>
				</tr>
				<tr>
