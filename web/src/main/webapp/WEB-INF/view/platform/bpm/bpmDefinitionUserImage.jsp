	...
	$(function(){
		$.each($("div.flowNode"),function(){
			if($(this).attr('type')=='userTask' || $(this).attr('type')=='multiUserTask'){
				...
				$(this).powerFloat({ eventType: "click", target: "${ctx}/platform/bpm/bpmDefinition/nodeUser.xht?processDefinitionId=${processDefinitionId}&nodeId=" + nodeId, targetMode: "ajax"});
			}
		});
	});
</script>
