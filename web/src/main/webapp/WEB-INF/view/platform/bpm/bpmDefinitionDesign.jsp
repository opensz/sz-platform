...
<%
	...
	Object copyIdObj = request.getAttribute("copyId");
	String copyId = "";
	if(copyIdObj != null){
		copyId = copyIdObj.toString();
	}
	String uId = request.getAttribute("uId").toString();
	// 在flex中保存，发布流程的请求地址
	String postUrl = basePath + "/platform/bpm/bpmDefinition/flexDefSave.xht";
	...
	if(defIdObj != null && !defIdObj.toString().equals("0")){
		...
		loadDateUrl = basePath + "/platform/bpm/bpmDefinition/flexGet.xht?defId=" + defId;
	}else{
		//
		//创建并且有copy
		if(!"".equals(copyId)){
			loadDateUrl = basePath + "/platform/bpm/bpmDefinition/flexGet.xht?defId=" + defId + "&copyId=" + copyId;
		}
	}
	
	String paramFlashVars =  "flowKeyGetUrl="+basePath+"/platform/bpm/bpmDefinition/getFlowKey.ht&flowListGetUrl="+basePath+"/platform/bpm/bpmDefinition/getFlowListByTypeId.xht";
%>
  ...
  <style type="text/css" media="screen"> 
	...
	#flashContent { display:none; }
       ...
       <script type="text/javascript">
	       ...
	       var xiSwfUrlStr = "<%=basePath%>/media/swf/common/playerProductInstall.swf";
	       var flashvars = {};
	       var params = {};
	       params.quality = "high";
	       ...
	       params.FlashVars = "<%=paramFlashVars%>";
	       var attributes = {};
