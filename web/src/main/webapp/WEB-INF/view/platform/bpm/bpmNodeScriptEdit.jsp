...
<script type="text/javascript">
		...
		function save(){
			 ...
			 var url=__ctx+ "/platform/bpm/bpmNodeScript/save.xht";
...
<div class="panel">
		<div class="panel-top">
			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<div class="group"><a class="link search" id="btnSearch">保存</a></div>
		...
		<div class="panel-body">
				<form id="bpmNodeScriptForm" method="post" action="save.xht">
					<c:if test="${type eq 'startEvent' }">
						<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
							<tr>
								<th width="20%">脚本描述:<span class="required">*</span> </th>
								<td>
									<input type="text"  name="memo" value="${afterModel.memo }"  class="inputText"/>
							...
							<tr>
								...
								<td>
									<div>
										<a href="#"  class="link var" title="选择流程变量" onclick="slectVars('startScript')">流程变量</a>
									...
									<textarea id="startScript" name="script" rows="16" cols="80" >${afterModel.script}</textarea>
								</td>
							</tr>
						</table>
					</c:if>
					<c:if test="${type eq 'endEvent'}">
						<table class="table-detail" cellpadding="0" cellspacing="0" border="0"  >
							<tr>
								<th width="20%">脚本描述:<span class="required">*</span> </th>
								<td>
									<input type="text"  name="memo" value="${preModel.memo }"  class="inputText"/>
							...
							<tr>
								...
								<td>
									<div>
										<a href="#"  class="link var" title="选择流程变量" onclick="slectVars('endScript')">流程变量</a>
									...
									<textarea id="endScript" name="script" rows="16" cols="80"  >${preModel.script}</textarea>
								</td>
							</tr>
						</table>
					</c:if>
					<c:if test="${type eq 'script' }">
						<table class="table-detail" cellpadding="0" cellspacing="0" border="0" style='${type eq "script"?'display:':'display:none'}'>
								<tr>
									<th width="20%">脚本描述:<span class="required">*</span> </th>
									<td>
										<input type="text"  name="memo" value="${scrptModel.memo }"  class="inputText"/>
								...
								<tr>
									...
									<td>
										<div>
											<a href="#"  class="link var" title="选择流程变量" onclick="slectVars('scriptScript')">流程变量</a>
										...
										<textarea id="scriptScript" name="script" rows="16" cols="80" >${scrptModel.script}</textarea>
									</td>
								</tr>
						</table>
					</c:if>
					  ...
					  <div tabid="startScript" title="前置脚本">
					     ...
					     <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
									...
									<tr>
										...
										<td>
											<div>
												<a href="#"  class="link var" title="选择流程变量" onclick="slectVars('preScript')">流程变量</a>
											...
											<textarea id="preScript" name="script" rows="16" cols="80"  >${preModel.script}</textarea>
										</td>
									</tr>
					    </table>
		              </div>
		              <div tabid="endScript" title="后置脚本" >
					     <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
									...
									<tr>
										...
										<td>
											<div>
												<a href="#"  class="link var" title="选择流程变量" onclick="slectVars('afterScript')">流程变量</a>
											...
											<textarea id="afterScript" name="script" rows="16" cols="80" >${afterModel.script}</textarea>
										</td>
									</tr>
					    </table>
		              </div>
		              <div tabid="assignScript" title="分配脚本" >
					     <table class="table-detail" cellpadding="0" cellspacing="0" border="0">
									<tr>
										<th width="20%">脚本描述:<span class="required">*</span> </th>
										<td>
											<input type="text"  name="memo" value="${assignModel.memo }"  class="inputText"/>
									...
									<tr>
										...
										<td>
											<div>
												<a href="#"  class="link var" title="选择流程变量" onclick="slectVars('assignScript')">流程变量</a>
											...
											<textarea id="assignScript" name="script" rows="16" cols="80" >${assignModel.script}</textarea>
										</td>
									</tr>
					    </table>
		              </div>
