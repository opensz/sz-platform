...
<html>
    <head>
        ...
        <script type="text/javascript">
            	...
            	function onClick( treeNode){
            		...
            		var url="${ctx}/platform/bpm/bpmDefinition/list.xht?typeId="+typeId;
    ...
    <body>
      	<div id="defLayout" >
            ...
            <div position="center" title="流程定义管理">
          		<iframe id="defFrame" height="100%" width="100%" frameborder="0" src="${ctx}/platform/bpm/bpmDefinition/list.xht"></iframe>
            </div>
        </div>
