				...
				<div class="panel-body">
					<div class="panel-search">
							<form id="searchForm" method="post" action="list.xht">
									<div class="row">
												<span class="label">流程实例ID:</span><input type="text" name="Q_actInstId_S"  class="inputText" />
											
												<span class="label">流程节点名称:</span><input type="text" name="Q_nodeName_S"  class="inputText" />
											
												<span class="label">nodeId:</span><input type="text" name="Q_nodeId_S"  class="inputText" />
											
												<span class="label">会签任务Id:</span><input type="text" name="Q_taskId_S"  class="inputText" />
											
												<span class="label">投票人ID:</span><input type="text" name="Q_voteUserId_S"  class="inputText" />
											
												<span class="label">投票人名:</span><input type="text" name="Q_voteUserName_S"  class="inputText" />
											
												<span class="label">投票时间 从:</span> <input  name="Q_beginvoteTime_S"  class="inputText date" />
												<span class="label">至: </span><input  name="Q_endvoteTime_S" class="inputText date" />
											
												<span class="label">是否同意:</span><input type="text" name="Q_isAgree_SN"  class="inputText" />
											
												<span class="label">投票意见内容:</span><input type="text" name="Q_content_S"  class="inputText" />
											
												<span class="label">signNums:</span><input type="text" name="Q_signNums_S"  class="inputText" />
											
												<span class="label">是否完成:</span><input type="text" name="Q_isCompleted_SN"  class="inputText" />
					...
					<div class="panel-data">
					    ...
					    <display:table name="taskSignDataList" id="taskSignDataItem" requestURI="list.xht" sort="external" cellpadding="1" cellspacing="1" export="true"  class="table-grid">
							...
							<display:column title="管理" media="html" style="width:180px">
								<a href="del.xht?dataId=${taskSignDataItem.dataId}" class="link del">删除</a>
								<a href="edit.xht?dataId=${taskSignDataItem.dataId}" class="link edit">编辑</a>
								<a href="get.xht?dataId=${taskSignDataItem.dataId}" class="link detail">明细</a>
							</display:column>
						</display:table>
						<sz:paging tableId="taskSignDataItem"/>
					</div>
