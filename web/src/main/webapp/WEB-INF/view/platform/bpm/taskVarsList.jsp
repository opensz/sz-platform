...
<script type="text/javascript" src="${ctx }/js/sz/platform/bpm/TaskVarsWindow.js"></script> 
			...
			<div class="panel">
				...
				<div class="panel-body">
					<div class="panel-search">
						...
						<form id="searchForm" method="post" action="list.xht?taskId=${taskId }">
							<div class="row">
								<span class="label">变量名称:</span><input type="text" name="Q_name_S"  class="inputText" style="width:13%;"/>
							</div>
						</form>
					</div>
					<div class="panel-data">
						...
						<display:table name="taskVarsList" id="taskVarItem" requestURI="list.xht" sort="external" cellpadding="1" cellspacing="1"  class="table-grid">
