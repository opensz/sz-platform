...
<head>
	...
	function showRequest(formData, jqForm, options) { 
		...
		function save(){
			...
			var url=__ctx+ "/platform/bpm/taskApprovalItems/save.xht";
		...
		function changeNodeId(value){
			...
			var url=__ctx+ "/platform/bpm/taskApprovalItems/get.xht";
   		 	var para=$('#taskApprovalItemsForm').serialize();
...
<div class="panel">
	...
	<div class="panel-body">
		<form id="taskApprovalItemsForm" method="post" action="save.xht">
			<table class="table-detail" cellpadding="0" cellspacing="0" border="0">
				...
				<tr id="trTaskNode">
					...
					<td>
						...
						<div id="defNodeDiv">
							<select id="defNode" name="defNode" style="width: 20%;" onchange="changeNodeId(value)">
