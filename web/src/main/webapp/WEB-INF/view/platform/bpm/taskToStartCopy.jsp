...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/sz/platform/bpm/TaskJumpWindow.js"></script>
		<script type="text/javascript" src="${ctx}/js/sz/platform/bpm/TaskSignWindow.js"></script>
		<script type="text/javascript" src="${ctx}/js/sz/platform/bpm/TaskAddSignWindow.js"></script>
		<script type="text/javascript" src="${ctx}/js/sz/platform/bpm/TaskBackWindow.js"></script>
		...
		function showTaskUserDlg()
		{
			new HtWindow({
				...
				width:650,
				frameid:'taskUserFrm',
				url:'${ctx}/platform/bpm/processRun/userImage.xht?taskId=${task.id}'
			}).show();
		}
		...
		$(function(){
			...
			$("#taskOpinionDiv").load('${ctx}/platform/bpm/taskOpinion/list.xht?actInstId=${task.processInstanceId}'.getNewUrl());
		});
            ...
            <div position="center">
	            ...
	            <div class="panel">
					...
					<div class="panel-body">
						<form id="taskForm" action="${ctx}/platform/bpm/task/complete.xht" method="post" >
