			...
			<div class="panel-toolbar">
				<div class="toolBar">
					<c:if test="${outMail.types==1}">
						<div class="group"><a class="link update" href="reply.xht?mailId=${outMail.mailId}&isReply=1&outMailSetId=${outMailSetId}">回复</a></div>
						<div class="l-bar-separator"></div>
					</c:if>
					<div class="group">
						<a class="link back" href="list.xht?id=${outMailSetId}&types=${outMail.types}">返回</a>
					</div>
				</div>
			</div>
		</div>
