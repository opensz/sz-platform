...
public class PdfView implements BinaryExportView {
	...
	protected void initTable() throws BadElementException {
		...
		this.smallFont = FontFactory.getFont("STSong-Light", "UniGB-UCS2-H",
				12.0F);
	}
	...
	public void doExport(OutputStream out) throws JspException {
		try {
			...
			Document document = new Document(PageSize.A4.rotate(), 60.0F,
					60.0F, 40.0F, 40.0F);
	...
	static class PdfGenerationException extends BaseNestableJspTagException {
		...
		public PdfGenerationException(Throwable cause) {
			super(PdfView.class, Messages.getString("PdfView.errorexporting"),
					cause);
		}
