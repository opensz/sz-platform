...
import org.sz.core.page.PageUtils;
 ...
 public class PageNav
 {
   ...
   public String getNumber()
   {
     ...
     List<Integer> list = PageUtils.getPageNumbers(this._pv.getCurrentPage(), this._pv.getTotalPage(), this.count);
   ...
   private String showJumpPage() throws Exception
   {
     ...
     sb.append("if(value.indexOf(\".\")==-1 && value.indexOf(\"-\")==-1 && value!==\"\" && !isNaN(value) && value<" + (this._pv.getTotalPage() + 1) + "){");
   ...
   private String showPageNav() throws Exception
   {
     ...
     if (this._pv.isHasPreviousPage())
       sb.append("<a href=\"" + this.strUrl + "?page=" + this._pv.getPreviousPage() + this._strPara + "\">上一页</a>");
     else
