...
public class DesktopColumnController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request,
		...
		List list = this.desktopColumnService.getAll(new WebQueryFilter(
				request, "desktopColumnItem"));
	...
	public ModelAndView get(HttpServletRequest request,
		...
		DesktopColumn desktopColumn = (DesktopColumn) this.desktopColumnService
	...
	public void init(HttpServletRequest request, HttpServletResponse response)
		...
		ResultMessage message = null;
		try {
			this.desktopColumnService.initAllTemplate(ContextUtil
