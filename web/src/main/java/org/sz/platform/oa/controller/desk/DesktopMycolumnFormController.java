...
public class DesktopMycolumnFormController extends BaseFormController {
	...
	public void save(HttpServletRequest request, HttpServletResponse response,
			DesktopMycolumn desktopMycolumn, BindingResult bindResult)
			throws Exception {
		ResultMessage resultMessage = validForm("desktopMycolumn",
				desktopMycolumn, bindResult, request);
	...
	@ModelAttribute
	protected DesktopMycolumn getFormObject(@RequestParam("id") Long id,
