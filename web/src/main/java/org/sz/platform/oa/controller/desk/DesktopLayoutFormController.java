...
public class DesktopLayoutFormController extends BaseFormController {
	...
	public void save(HttpServletRequest request, HttpServletResponse response,
			DesktopLayout desktopLayout, BindingResult bindResult)
			throws Exception {
		ResultMessage resultMessage = validForm("desktopLayout", desktopLayout,
				bindResult, request);
	...
	@ModelAttribute
	protected DesktopLayout getFormObject(@RequestParam("id") Long id,
