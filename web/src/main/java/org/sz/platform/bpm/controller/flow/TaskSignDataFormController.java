...
public class TaskSignDataFormController extends BaseFormController {
	...
	public void save(HttpServletRequest request, HttpServletResponse response,
			TaskSignData taskSignData, BindingResult bindResult)
			throws Exception {
		ResultMessage resultMessage = validForm("taskSignData", taskSignData,
				bindResult, request);
	...
	@ModelAttribute
	protected TaskSignData getFormObject(@RequestParam("dataId") Long dataId,
