...
public class BpmFormRuleController extends BaseController
{
  ...
  public ModelAndView list(HttpServletRequest request, HttpServletResponse response)
    throws Exception
  {
    List list = this.bpmFormRuleService.getAll(new WebQueryFilter(request, "bpmFormRuleItem"));
    ...
    throws Exception
  {
    ...
    BpmFormRule bpmFormRule = (BpmFormRule)this.bpmFormRuleService.getById(Long.valueOf(id));
  ...
  @ResponseBody
  public Map getAllRules(HttpServletRequest request,HttpServletResponse response)throws IOException
  {
