...
import org.sz.platform.bpm.service.flow.BpmTableTemprightsService;
 ...
 public class BpmTableTemprightsFormController extends BaseFormController
 {
     ...
     throws Exception
   {
     ...
     try
     {
       this.bpmTableTemprightsService.saveRights(id, type, rightType, ownerId, ownerName);
   ...
   @ModelAttribute
   protected BpmTableTemprights getFormObject(@RequestParam("id") Long id, Model model)
     throws Exception
   {
