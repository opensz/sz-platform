...
import org.sz.platform.bpm.service.form.BpmFormTemplateService;
 ...
 public class BpmFormTemplateFormController extends BaseFormController
 {
   ...
   public void save(HttpServletRequest request, HttpServletResponse response, BpmFormTemplate bpmFormTemplate, BindingResult bindResult)
     throws Exception
   {
   ...
   @ModelAttribute
   protected BpmFormTemplate getFormObject(@RequestParam("templateId") Long templateId, Model model)
     throws Exception
   {
