...
import org.sz.platform.bpm.service.flow.BpmNodeSetService;
 ...
 public class BpmNodeRuleFormController extends BaseFormController
 {
   ...
   public void save(HttpServletRequest request, HttpServletResponse response, BpmNodeRule bpmNodeRule, BindingResult bindResult)
     throws Exception
   {
   ...
   @ModelAttribute
   protected BpmNodeRule getFormObject(@RequestParam("ruleId") Long ruleId, Model model)
     throws Exception
   {
