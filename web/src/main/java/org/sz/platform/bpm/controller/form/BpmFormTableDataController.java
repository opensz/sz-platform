...
public class BpmFormTableDataController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request,
		...
		String html = this.freemarkEngine.parseByStringTemplate(data,
				listTemplate);
	...
	public ModelAndView detail(HttpServletRequest request,
			HttpServletResponse response,
			@RequestParam(value = "page", defaultValue = "1") int page,
			Long tableId, String pkValue) throws Exception {
		BpmFormTable table = (BpmFormTable) this.bpmFormTableService
				.getById(tableId);
		...
		return getAutoView().addObject("html", writer.toString()).addObject(
