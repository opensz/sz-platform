...
import org.sz.platform.bpm.service.flow.TaskSignDataService;
 ...
 public class TaskSignDataController extends BaseController
 {
   ...
   public ModelAndView list(HttpServletRequest request, HttpServletResponse response)
     throws Exception
   {
     List list = this.taskSignDataService.getAll(new WebQueryFilter(request, "taskSignDataItem"));
   ...
   public ModelAndView edit(HttpServletRequest request) throws Exception {
     ...
     return getAutoView().addObject("taskSignData", taskSignData).addObject("returnUrl", returnUrl);
   }
     ...
     throws Exception
   {
     ...
     TaskSignData taskSignData = (TaskSignData)this.taskSignDataService.getById(Long.valueOf(id));
