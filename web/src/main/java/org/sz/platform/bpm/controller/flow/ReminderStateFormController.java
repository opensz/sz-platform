...
public class ReminderStateFormController extends BaseFormController {
	...
	public void save(HttpServletRequest request, HttpServletResponse response,
			ReminderState reminderState, BindingResult bindResult)
			throws Exception {
		ResultMessage resultMessage = validForm("reminderState", reminderState,
				bindResult, request);
	...
	@ModelAttribute
	protected ReminderState getFormObject(@RequestParam("id") Long id,
