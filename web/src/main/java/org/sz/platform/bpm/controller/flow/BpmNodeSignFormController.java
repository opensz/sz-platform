...
public class BpmNodeSignFormController extends BaseFormController {
	...
	public void save(HttpServletRequest request, HttpServletResponse response,
			BpmNodeSign bpmNodeSign, BindingResult bindResult) throws Exception {
		ResultMessage resultMessage = validForm("bpmNodeSign", bpmNodeSign,
				bindResult, request);
	...
	@ModelAttribute
	protected BpmNodeSign getFormObject(@RequestParam("signId") Long signId,
