...
public class BpmFormTemplateController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request,
		...
		List list = this.bpmFormTemplateService.getAll(new WebQueryFilter(
	...
	public ModelAndView get(HttpServletRequest request,
		...
		BpmFormTemplate bpmFormTemplate = (BpmFormTemplate) this.bpmFormTemplateService
	...
	public void copyTemplate(HttpServletRequest request,
			HttpServletResponse response, BpmFormTemplate template)
			throws Exception {
		long id = RequestUtil.getLong(request, "templateId");
		BpmFormTemplate bpmFormTemplate = (BpmFormTemplate) this.bpmFormTemplateService
				.getById(Long.valueOf(id));
