...
public class BpmTableTemprightsController extends BaseController {
	...
	public ModelAndView edit(HttpServletRequest request) throws Exception {
		...
		return getAutoView()
				.addObject("bpmTableTemprights", bpmTableTemprights).addObject(
						"returnUrl", returnUrl);
	}
	...
	public ModelAndView get(HttpServletRequest request,
		...
		BpmTableTemprights bpmTableTemprights = (BpmTableTemprights) this.bpmTableTemprightsService
				.getById(Long.valueOf(id));
		return getAutoView()
				.addObject("bpmTableTemprights", bpmTableTemprights);
	}
}
