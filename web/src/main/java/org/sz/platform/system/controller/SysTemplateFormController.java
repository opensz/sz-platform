...
public class SysTemplateFormController extends BaseFormController {
	...
	public void save(HttpServletRequest request, HttpServletResponse response,
			SysTemplate sysTemplate, BindingResult bindResult) throws Exception {
		ResultMessage resultMessage = validForm("sysTemplate", sysTemplate,
				bindResult, request);
	...
	@ModelAttribute
	protected SysTemplate getFormObject(
