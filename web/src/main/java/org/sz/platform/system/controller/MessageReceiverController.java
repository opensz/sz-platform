...
public class MessageReceiverController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request,
		...
		ModelAndView mv = getAutoView().addObject("messageReceiverList", list)
				.addObject("pam", queryFilter.getFilters());
	...
	public ModelAndView edit(HttpServletRequest request) throws Exception {
		...
		if (id.longValue() != 0L)
			messageReceiver = (MessageReceiver) this.receiverService
					.getById(id);
		else {
	...
	public ModelAndView get(HttpServletRequest request,
		...
		MessageReceiver messageReceiver = (MessageReceiver) this.receiverService
