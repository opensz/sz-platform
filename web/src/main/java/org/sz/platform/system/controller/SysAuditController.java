...
public class SysAuditController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request,
		...
		List list = this.sysAuditService.getAll(new WebQueryFilter(request,
				"sysAuditItem"));
	...
	public ModelAndView edit(HttpServletRequest request,
			@RequestParam("auditId") Long auditId) throws Exception {
		...
		return getAutoView().addObject("sysAudit", po).addObject("returnUrl",
				returnUrl);
	}
