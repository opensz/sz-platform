...
import org.sz.platform.system.service.DesktopLayoutService;
 ...
 public class DesktopLayoutController extends BaseController
 {
   ...
   public ModelAndView list(HttpServletRequest request, HttpServletResponse response)
     throws Exception
   {
     List list = this.desktopLayoutService.getAll(new WebQueryFilter(request, "desktopLayoutItem"));
     ...
     throws Exception
   {
     ...
     DesktopLayout desktopLayout = (DesktopLayout)this.desktopLayoutService.getById(Long.valueOf(id));
   ...
   {
     Long id = Long.valueOf(RequestUtil.getLong(request, "id"));
     DesktopLayout bean = (DesktopLayout)this.desktopLayoutService.getById(id);
   ...
   public void setupDefault(HttpServletRequest request, HttpServletResponse response)
     throws Exception
   {
     String preUrl = RequestUtil.getPrePage(request);
     ResultMessage message = null;
