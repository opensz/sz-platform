...
import org.sz.platform.system.service.SysUserService;
 ...
 public class SysFileController extends BaseController
 {
   ...
   public ModelAndView list(HttpServletRequest request, HttpServletResponse response) throws Exception { Long typeId = Long.valueOf(RequestUtil.getLong(request, "typeId"));
   ...
   public void saveFile(MultipartHttpServletRequest request, HttpServletResponse response)
     throws Exception
   {
     PrintWriter writer = response.getWriter();
     try {
