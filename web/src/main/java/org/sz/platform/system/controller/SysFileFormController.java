...
public class SysFileFormController extends BaseFormController {
	...
	public void save(HttpServletRequest request, HttpServletResponse response,
			SysFile sysFile, BindingResult bindResult) throws Exception {
		ResultMessage resultMessage = validForm("sysFile", sysFile, bindResult,
				request);
	...
	@ModelAttribute
	protected SysFile getFormObject(@RequestParam("fileId") Long fileId,
