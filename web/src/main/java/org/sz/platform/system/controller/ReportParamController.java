...
public class ReportParamController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request,
		...
		List list = this.reportParamService.getAll(new WebQueryFilter(request,
				"reportParamItem"));
	...
	public ModelAndView edit(HttpServletRequest request) throws Exception {
		...
		return getAutoView().addObject("reportParam", reportParam).addObject(
				"returnUrl", returnUrl);
	}
	...
	public ModelAndView get(HttpServletRequest request,
		...
		ReportParam reportParam = (ReportParam) this.reportParamService
