...
public class SysUserOrgController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request,
		...
		List list = this.sysUserOrgService.getAll(new WebQueryFilter(request,
				"sysUserOrgItem"));
	...
	public ModelAndView edit(HttpServletRequest request) throws Exception {
		Long userOrgId = Long
				.valueOf(RequestUtil.getLong(request, "userOrgId"));
		...
		return getAutoView().addObject("sysUserOrg", sysUserOrg).addObject(
				"returnUrl", returnUrl);
	}
	...
	public ModelAndView get(HttpServletRequest request,
		...
		SysUserOrg sysUserOrg = (SysUserOrg) this.sysUserOrgService
	...
	public ModelAndView userList(HttpServletRequest request,
		...
		if (sysOrg == null) {
			...
			mv.addObject("sysOrgUserList", list).addObject("orgId", orgId)
	...
	public void addOrgUser(HttpServletRequest request,
			HttpServletResponse response) throws Exception {
