...
import org.sz.platform.system.service.UserRoleService;
 ...
 public class UserRoleController extends BaseController
 {
   ...
   public ModelAndView edit(HttpServletRequest request) throws Exception { ModelAndView mv = getAutoView();
     Long roleId = Long.valueOf(RequestUtil.getLong(request, "roleId"));
     QueryFilter queryFilter = new WebQueryFilter(request, "userRoleItem", true);
