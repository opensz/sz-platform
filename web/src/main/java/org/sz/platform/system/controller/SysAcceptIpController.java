...
public class SysAcceptIpController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request,
		...
		List list = this.sysAcceptIpService.getAll(new WebQueryFilter(request,
				"sysAcceptIpItem"));
	...
	public ModelAndView edit(HttpServletRequest request) throws Exception {
		...
		return getAutoView().addObject("sysAcceptIp", sysAcceptIp).addObject(
				"returnUrl", returnUrl);
	}
	...
	public ModelAndView get(HttpServletRequest request,
		...
		SysAcceptIp sysAcceptIp = (SysAcceptIp) this.sysAcceptIpService
