...
public class SysUserOrgFormController extends BaseFormController {
	...
	public void save(HttpServletRequest request, HttpServletResponse response,
			SysUserOrg sysUserOrg, BindingResult bindResult) throws Exception {
		ResultMessage resultMessage = validForm("sysUserOrg", sysUserOrg,
				bindResult, request);
	...
	@ModelAttribute
	protected SysUserOrg getFormObject(
			@RequestParam("userOrgId") Long userOrgId, Model model)
			throws Exception {
