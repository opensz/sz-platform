...
public class SysAcceptIpFormController extends BaseFormController {
	...
	public void save(HttpServletRequest request, HttpServletResponse response,
			SysAcceptIp sysAcceptIp, BindingResult bindResult) throws Exception {
		ResultMessage resultMessage = validForm("sysAcceptIp", sysAcceptIp,
				bindResult, request);
	...
	@ModelAttribute
	protected SysAcceptIp getFormObject(
			@RequestParam("acceptId") Long acceptId, Model model)
			throws Exception {
		this.logger.debug("enter SysAcceptIp getFormObject here....");
		SysAcceptIp sysAcceptIp = null;
		if (acceptId != null)
			sysAcceptIp = (SysAcceptIp) this.sysAcceptIpService
					.getById(acceptId);
		else {
