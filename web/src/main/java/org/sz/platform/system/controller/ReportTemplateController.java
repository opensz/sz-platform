...
public class ReportTemplateController extends BaseController {
	...
	public ModelAndView list(HttpServletRequest request,
		...
		List list = this.reportTemplateService.getAll(new WebQueryFilter(
				request, "reportTemplateItem"));
	...
	public ModelAndView edit(HttpServletRequest request) throws Exception {
		...
		return getAutoView().addObject("reportTemplate", reportTemplate)
				.addObject("returnUrl", returnUrl).addObject("typelist", list);
	}
	...
	public void save(MultipartHttpServletRequest request,
			HttpServletResponse response, ReportTemplate reportTemplate)
			throws Exception {
		...
		if (it.hasNext()) {
			...
			String filePath = FileUtil.getRootPath() + "WEB-INF\\"
					+ "reportlets" + "\\" + oriFileName;
			FileUtil.writeByte(filePath, f.getBytes());

			this.reportTemplateService.saveReportTemplate(reportTemplate,
					"\\WEB-INF\\reportlets\\" + oriFileName,
