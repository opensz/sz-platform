...
//   private BpmAgentService bpmAgentService;
   ...
   public ModelAndView edit(HttpServletRequest request) throws Exception {
     ...
     if (agentid.longValue() != 0L) {
       sysUserAgent = (SysUserAgent)this.sysUserAgentService.getById(agentid);
...
//       mv.addObject("bpmAgentList", bpmAgentList);
     ...
     throws Exception
   {
     ...
     SysUserAgent sysUserAgent = (SysUserAgent)this.sysUserAgentService.getById(Long.valueOf(id));
