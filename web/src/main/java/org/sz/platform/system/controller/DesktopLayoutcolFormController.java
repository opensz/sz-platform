...
import org.sz.platform.system.service.DesktopLayoutcolService;
 ...
 public class DesktopLayoutcolFormController extends BaseFormController
 {
   ...
   public void save(HttpServletRequest request, HttpServletResponse response, DesktopLayoutcol desktopLayoutcol, BindingResult bindResult)
     throws Exception
   {
   ...
   @ModelAttribute
   protected DesktopLayoutcol getFormObject(@RequestParam("id") Long id, Model model)
     throws Exception
   {
     this.logger.debug("enter DesktopLayoutcol getFormObject here....");
     DesktopLayoutcol desktopLayoutcol = null;
     if (id != null)
       desktopLayoutcol = (DesktopLayoutcol)this.desktopLayoutcolService.getById(id);
     else {
