 ...
 public class UserPositionController extends BaseController
 {
   ...
   public ModelAndView edit(HttpServletRequest request) throws Exception {
     ...
     if (position != null) {
       ...
       List list = this.userPositionService.getAll(new WebQueryFilter(request, "userPositionItem", true));
   ...
   public ModelAndView get(HttpServletRequest request) throws Exception {
     ...
     if (position != null) {
       mv.addObject("position", position);
       List list = this.userPositionService.getAll(new WebQueryFilter(request, "userPositionItem", false));
       mv.addObject("userPositionList", list);
     }
