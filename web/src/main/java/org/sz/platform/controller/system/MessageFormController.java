...
import org.sz.platform.service.system.MessageService;
 ...
 public class MessageFormController extends BaseFormController
 {
   ...
   public void save(HttpServletRequest request, HttpServletResponse response, Message message, BindingResult bindResult)
     throws Exception
   {
   ...
   @ModelAttribute
   protected Message getFormObject(@RequestParam("messageId") Long messageId, Model model)
     throws Exception
   {
