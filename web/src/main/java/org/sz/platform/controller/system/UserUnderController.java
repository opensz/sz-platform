...
import org.sz.platform.service.system.UserUnderService;
 ...
 public class UserUnderController extends BaseController
 {
     ...
     throws Exception
   {
     ...
     UserUnder userUnder = (UserUnder)this.userUnderService.getById(Long.valueOf(id));
   ...
   public void addUnderUser(HttpServletRequest request, HttpServletResponse response) throws Exception {
     ...
     this.userUnderService.addMyUnderUser(Long.valueOf(userId), userIds, userNames);
   }
 }
