...
import org.sz.platform.service.system.MessageSendService;
 ...
 public class MessageSendFormController extends BaseFormController
 {
   ...
   public void save(HttpServletRequest request, HttpServletResponse response, MessageSend messageSend, BindingResult bindResult)
     throws Exception
   {
     ...
     this.messageSendService.addMessageSend(messageSend, curUser, receiverId, receiverName, receiverOrgId, receiverOrgName);
